...
class Team {
  ...
  factory Team.create({required String name, required String timeZone, required CurrencyCode currencyCode}) {
    return Team(name: name, timeZone: timeZone, currencyCode: currencyCode);
  }
  ...
  factory Team.fromJson(Map<String, dynamic> json) {
    return Team(
      ...
      currencyCode: CurrencyCode.values.byName(json['currency_code']) ,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'time_zone': timeZone,
      'currency_code': currencyCode.name,
