...
class CurrencyTextInputFormatter extends TextInputFormatter {
  ...
  void _formatter(String newText) {
    final format = NumberFormatterUtils.getFormatterWithoutSymbol(currencyCode: currencyCode);
    if (turnOffGrouping) {
...
//     // double parsedValue = double.tryParse(newValue.text.replaceAll(',', '')) ?? 0.0;
//     String formattedValue = currencyFormat.format(double.parse(newValue.text) );
...
//     // String newText = NumberFormatterUtils.currencyFormatWithoutSymbol(value: value, currencyCode: currencyCode);
